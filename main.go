...
func probeHandler(w http.ResponseWriter, r *http.Request, c *config.Config, logger log.Logger, rh *resultHistory) {
	...
	respTime.With(prometheus.Labels{"InstanceRegion":"cn_shenzhen", "QuestIP":"1.1.1.1", "ProbeTarget":"http://1.1.1.1:80/check", "sid":"588", "url":"http://1.1.1.1:80/check","Domain":"1.1.1.1","Project":"aproject","Tables":"ProRealMonitor"}).Add(0.862)
	...
	statusCode.With(prometheus.Labels{"InstanceRegion":"cn_shenzhen", "QuestIP":"1.1.1.1", "ProbeTarget":"http://1.1.1.1:80/check", "sid":"588", "url":"http://1.1.1.1:80/check","Domain":"1.1.1.1","Project":"aproject","Tables":"ProRealMonitor"}).Add(200)
...
// int function
func run() int {
	// load config  and read flag args
	...
	// Infer or set Blackbox exporter externalURL 判断设置参数是否正确
	...
	// Default -web.route-prefix to path of -web.external-url. 判断设置的 uri
	if *routePrefix == "" {
